...
funcs.json = require('ImageProcessing/MultiImageEdgeMatcher/helper/Json')
-- Default parameters for instances of module
funcs.defaultParameters = require('ImageProcessing/MultiImageEdgeMatcher/MultiImageEdgeMatcher_Parameters')
