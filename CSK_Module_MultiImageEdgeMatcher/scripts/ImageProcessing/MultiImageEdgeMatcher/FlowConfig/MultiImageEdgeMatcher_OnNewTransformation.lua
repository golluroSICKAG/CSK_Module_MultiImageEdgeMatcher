-- Block namespace
local BLOCK_NAMESPACE = "MultiImageEdgeMatcher_FC.OnNewTransformation"
...
local function register(handle, _ , callback)
  ...
  local function localCallback()
    if callback ~= nil then
      Script.callFunction(callback, 'CSK_MultiImageEdgeMatcher.OnNewTransformation' .. tostring(instance))
    else
