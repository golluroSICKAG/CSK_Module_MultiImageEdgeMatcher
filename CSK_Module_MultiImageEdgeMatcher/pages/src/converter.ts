...
export function changeStyle(theme) {
  ...
  if (theme == 'CSK_Style'){
    ...
    var customBackground =  `.CSK_Module_MultiImageEdgeMatcher .myCustomBackground_CSK_Module_MultiImageEdgeMatcher { background-color: #737F8522; }` // font-family: "Open Sans"; }`
    ...
    var customBackground =  `.CSK_Module_MultiImageEdgeMatcher .myCustomBackground_CSK_Module_MultiImageEdgeMatcher { background-color: #fff; }` // font-family: "sans-serif"; }`
